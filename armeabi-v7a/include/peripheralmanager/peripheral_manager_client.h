...
char** APeripheralManagerClient_listLeds(const APeripheralManagerClient* client,
                                         int* num_leds);
...
/// @return 0 on success, errno on error.
int APeripheralManagerClient_openLed(const APeripheralManagerClient* client,
                                     const char* name,
                                     BLed** led);
